...
descriptor_opts.type='BRLD';
descriptor_opts.name=['des',descriptor_opts.type];
GenerateBrldDescriptors(pg_opts,descriptor_opts);
...
dictionary_opts.name='BRLD_features';
dictionary_opts.type='BRLD_dictionary';
CalculateBRLDDictionary(pg_opts,dictionary_opts);
...
do_index(pg_opts,assignment_opts,3);
